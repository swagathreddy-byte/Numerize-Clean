...
#SENDGRID_API_KEY = env.str('AWS_ACCESS_KEY_ID')
...
LOGGING = {
    ...
    'formatters': {
        'standard': {
            'format' : "[%(asctime)s] workspace %(levelname)s [%(name)s:%(lineno)s] %(message)s",
            'datefmt' : "%d/%b/%Y %H:%M:%S"
        },
    },
    'handlers': {
...
CSRFTOKEN_API_URL="/api/security/getcsrftoken"
SAVEREPORT_API_URL="/api/reports/save"
CUSTOMER_SAVE_API_URL="/api/entities/customer/save"
LEGALENTITY_SAVE_API_URL="/api/entities/legalentity/save"
CU_LE_SAVE_API_URL="/api/entities/cu_le_link/save"
OUTLET_SAVE_API_URL="/api/entities/outlet/save"
LE_OT_SAVE_API_URL="/api/entities/le_ot_link/save"
BRAND_SAVE_API_URL="/api/entities/brand/save"
OT_B_SAVE_API_URL="/api/entities/ot_b_link/save"
USER_SAVE_API_URL="/api/users/save"
USR_ENT_SAVE_API_URL="/api/entities/usr_en_link/save"
CUSTOMER_GET_API_URL="/api/entities/customer/get"
OUTLET_GET_API_URL="/api/entities/outlet/get"
USER_GET_API_URL="/api/users/get"
